...
<div class="wrapper">
  ...
  <div id="projects">
    ...
    <h2>Social Interactions</h1>
    <p>"This project was created by 4 Seneca students. The project was designed with intentions to allows users to create an acccount and be able to view
      groups and events that are similiar to there interests.
      ...
      <p>"The website has guards on all the forms to make sure information is entered correctly.
        ...
        The website allows you to view groups and create groups for specfic hobbies or interests.
    ...
    <h3>Web422 - Angular</h1>
    <p>"This project is an angular application. In it using a template to create a well flowing website.
      The is supposed to allow you to view all employees in a database and parse through them by name or poistion.
    ...
    <h4>Web322 - Project</h1>
    <p>"This project was created to showcase abilties on handling a database and manpulating it inside a website.
      There is ways on adding new employees with details and departments, also the ability to add photos and see them on the website live.
